...
plt.scatter(2.6,1.,color='blue',s=100)
plt.scatter(4,2,color='darkorange',s=100)
plt.scatter(2.5,1.31,color='yellow',s=100,marker=',')
plt.scatter(4,1.72,color='yellow',s=100,marker=',')
